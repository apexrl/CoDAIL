...
class CategoricalPolicy(object):
    def __init__(self, sess, oppo_policy, ob_space, ac_space, op_ac_n, ob_spaces, ac_spaces,
        ...
        def step(ob, obs, a_v, *_args, **_kwargs):
            ...
            if a_v is not None:
                a, v = sess.run([a0, v0], {obs_x: ob, op_act_x:oppo_a, X_v: obs, A_v: a_v})
            else:
                a, v = sess.run([a0, v0], {obs_x: ob, op_act_x:oppo_a, X_v: obs})
    ...
    def __init__(self, sess, oppo_policy, ob_space, ac_space, op_ac_n, ob_spaces, ac_spaces,
        ...
        def step(ob, obs, a_v, *_args, **_kwargs):
            ...
            if a_v is not None:
                ...
                a, v = sess.run([a0, v0], {X: ob, op_act_x:oppo_a, X_v: obs})
            return a, v, []  # dummy state
